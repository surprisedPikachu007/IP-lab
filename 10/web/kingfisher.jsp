...
out.println("<h1><center>Indian Airlines</h1><br><h3>- Have a nice trip!!!</h3></center><br>");
...
try
{
sSql = "update " sTable" set SeatCapacity=" seat1 " WHERE FlightNo='" request.getParameter
("flight_no") "'";
